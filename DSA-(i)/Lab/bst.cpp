...
private:
    ...
    void delete2Child(Node *node)
    {
        ...
        if (targetNode->left == NULL and targetNode->right == NULL)
            delete0Child(targetNode);
        else
            delete1Child(targetNode);
    }
...
public:
    bool deleteNode(int val)
    {
        ...
        if (refNode->left == NULL and refNode->right == NULL)
            delete0Child(refNode);
        else if (refNode->left != NULL and refNode->right != NULL)
            delete2Child(refNode);
        else
            delete1Child(refNode);
